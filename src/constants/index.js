import {
  ...
  const experiences = [
    ...
    {
      title: "Athletic Operations Staff",
      company_name: "University of Wisconsin-Parkside",
      icon: parkside,
      iconBg: "#383E56",
    ...
    {
      title: "Student Director, Software Engineer",
      company_name: "App Factory UWP",
      icon: appfactory,
      iconBg: "#E6DEDD",
  ...
  const testimonials = [
    {
      testimonial:
        "I had the privilege of working with Reece at the App Factory, and I am pleased to recommend her without reservation.",
      name: "Zaid Altahat, Ph.D.",
      designation: "Director, CEO",
      company: "App Factory, Zetaton, Sydetasker",
      image: zaid,
    },
    {
      testimonial:
        "Her intellectual curiosity, passion, innovative mindset, technical expertise, and strong work ethic make her an asset in any computer science-related endeavor.",
      name: "Vijayalakshmi (Viji) Ramasamy, Ph.D.",
      designation: "Chair, Director, Professor",
      company: "UWP Department of Computer Science, MSCIS Program",
      image: viji,
    },
    {
      testimonial:
        "She is extremely competent and always follows through on her commitments. She has my highest recommendation!",
      name: "Jonathan Shailor, Ph.D.",
      designation: "Professor",
      company: "Communication at University of Wisconsin-Parkside",
      image: jonathan,
    },
  ];
